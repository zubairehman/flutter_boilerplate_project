...
- **Ordered initialization**: Local → Network → Repository, ensuring dependencies (including `SecureStorageHelper`, `SembastClient`) are available before dependents register.
