...
- **Note**: `GetPostUseCase` and `FindPostByIdUseCase` use `extends UseCase` while the user use cases use `implements UseCase` — minor inconsistency in subtyping style.
